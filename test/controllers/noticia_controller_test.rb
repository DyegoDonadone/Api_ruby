...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { chapeu: @noticium.chapeu, data: @noticium.data, fonte: @noticium.fonte, texto: @noticium.texto, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { chapeu: @noticium.chapeu, data: @noticium.data, fonte: @noticium.fonte, texto: @noticium.texto, titulo: @noticium.titulo } }
